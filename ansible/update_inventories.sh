...
# Paths and Variables
TERRAFORM_OUTPUT_DIR="/home/ubuntu/terraform-ansible/terraform"  # Replace with the actual Terraform directory path
ANSIBLE_INVENTORY_DIR="/home/ubuntu/terraform-ansible/ansible/inventories"
...
update_inventory_file() {
    ...
    echo "ansible_ssh_private_key_file=/home/ubuntu/devops-key" >> "$inventory_file"
...
update_inventory_file "$DEV_IPS" "$ANSIBLE_INVENTORY_DIR/dev.env" "dev"
update_inventory_file "$STG_IPS" "$ANSIBLE_INVENTORY_DIR/stg.env" "stg"
update_inventory_file "$PROD_IPS" "$ANSIBLE_INVENTORY_DIR/prod.env" "prod"
